...
test.describe("Applicant view all documents in citizen dashboard tests for citizen DA case", (): void => {
  test.slow();
  let ccdRef: string;
  ...
  test("Applicant view all documents. @accessibility @regression @nightly", async ({
    page,
    browser,
  }): Promise<void> => {
