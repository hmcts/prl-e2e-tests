...
test.describe("FL401 Create case applicant details tests @manageCases", (): void => {
  ...
  Not Error message testing,
  Saying no to all options,
  Female applicant @manageCasesNightlyPipeline`, async ({ page }): Promise<void> => {
    await FL401ApplicantDetails.fl401ApplicantDetails({
      page: page,
      accessibilityTest: false,
      errorMessaging: false,
  ...
  Error message testing,
  Saying yes to all options,
  Male applicant. @errorMessageManageCases`, async ({ page }): Promise<void> => {
    await FL401ApplicantDetails.fl401ApplicantDetails({
      page: page,
      accessibilityTest: false,
      errorMessaging: true,
...
test(`Complete the FL401 applicant details event as a solicitor with the following options:
  ...
  Not Error message testing,
  Saying yes to all options,
  Male applicant. @accessibilityManageCases`, async ({ page }): Promise<void> => {
  await FL401ApplicantDetails.fl401ApplicantDetails({
    page: page,
    accessibilityTest: true,
    errorMessaging: false,
