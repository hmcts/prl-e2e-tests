...
test.describe("Validating auto-generated case names for CA and DA cases", () => {
    ...
    [
        {
            updatedApplicantsName: { firstname: "UpdatedApplFN", surname: "UpdatedApplLN" },
            resultingCaseName: { newCaseName: "UpdatedApplLN V Richards" },
            updatedRespondentsName: { firstname: "newRespndentFN", surname: "newRespndentLN" },
            resultingCaseNameRespondent: { newCaseNameRespondent: "UpdatedApplLN V newRespndentLN" },
        },
    ].forEach(
        ({
