...
import {
  clippingCoords,
  ExuiMediaViewerPage,
} from "../../../pages/exui/exuiMediaViewer.po.js";
...
export class PreviewOrdersComponent {
  ...
  async assertOrdersPage20Contents(
    ...
    // assert drafted orders in media viewer
  ...
  getOrderNameFromOrderType(orderType: OrderTypes, isWelsh: boolean): string {
