...
export class C100Noc2Page extends EventPage {
  ...
  private readonly clientFirstNameField: Locator = this.page.locator('#NOCChallengeQ1');
  private readonly clientLastNameField: Locator = this.page.locator('#NOCChallengeQ2');
