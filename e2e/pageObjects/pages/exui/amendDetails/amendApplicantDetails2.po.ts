...
export class AmendApplicantDetails2Page extends EventPage {
  readonly firstName = this.page.locator("#applicantsFL401_firstName");
  readonly lastName = this.page.locator("#applicantsFL401_lastName");
  readonly previousName = this.page.locator("#applicantsFL401_previousName");

  readonly genderFemale = this.page.locator("#applicantsFL401_gender-female");
  readonly genderMale = this.page.locator("#applicantsFL401_gender-male");
  readonly genderOther = this.page.locator("#applicantsFL401_gender-other");
  readonly genderOtherInput = this.page.locator("#applicantsFL401_otherGender");
  ...
  readonly refugeYes = this.page.locator("#applicantsFL401_liveInRefuge_Yes");
  readonly c8FormUpload = "#applicantsFL401_refugeConfidentialityC8Form";

  readonly confidentialAddressYes = this.page.locator(
    "#applicantsFL401_isAddressConfidential_Yes",
  );
  readonly emailField = this.page.locator("#applicantsFL401_email");
  readonly confidentialEmailYes = this.page.locator(
    "#applicantsFL401_isEmailAddressConfidential_Yes",
  );
  readonly confidentialPhoneYes = this.page.locator(
    "#applicantsFL401_isPhoneNumberConfidential_Yes",
  );

  readonly solicitorFirstName = this.page.locator(
    "#applicantsFL401_representativeFirstName",
  );
  readonly solicitorLastName = this.page.locator(
    "#applicantsFL401_representativeLastName",
  );
  readonly solicitorEmail = this.page.locator(
    "#applicantsFL401_solicitorEmail",
  );
  readonly solicitorPhone = this.page.locator(
    "#applicantsFL401_solicitorTelephone",
  );
  readonly solicitorReference = this.page.locator(
    "#applicantsFL401_solicitorReference",
  );
  readonly solicitorPostcode = this.page.locator(
    "#applicantsFL401_solicitorAddress_solicitorAddress_postcodeInput",
  );
  readonly solicitorLookup = this.page.locator(
    "#applicantsFL401_solicitorAddress_solicitorAddress_postcodeLookup",
  );
  readonly solicitorSelectAddress = this.page.locator(
    "#applicantsFL401_solicitorAddress_solicitorAddress_addressList",
  );
