import { StartPage } from "../../pages/edgeCases/startPage";
import { TypeOfApplicationPage } from "../../pages/edgeCases/typeOfApplicationPage";
import { Page } from "@playwright/test";
import { EdgeCaseApplicationType } from "../../common/types";
import IdamLoginHelper from "../../utils/idamLoginHelper.utils";
import { UserRolePage } from "../../pages/edgeCases/personalDetails/userRolePage";
import { DateOfBirthPage } from "../../pages/edgeCases/personalDetails/dateOfBirthPage";
import { AddressLookupPage } from "../../pages/edgeCases/personalDetails/addressLookupPage";
import { AddressManualPage } from "../../pages/edgeCases/personalDetails/addressManualPage";
import { FullNamePage } from "../../pages/edgeCases/personalDetails/fullNamePage";
import { AddressSelectPage } from "../../pages/edgeCases/personalDetails/addressSelectPage";
import { EmailAddressPage } from "../../pages/edgeCases/personalDetails/emailAddressPage";
import { ContactDetailsPage } from "../../pages/edgeCases/personalDetails/contactDetailsPage";
import { SelectCourtPage } from "../../pages/edgeCases/selectCourtPage";
import { UploadYourDocumentsPage } from "../../pages/edgeCases/uploadApplicationDocuments/uploadYourDocumentsPage";
import { UploadAdditionalDocumentsPage } from "../../pages/edgeCases/uploadApplicationDocuments/uploadAdditionalDocumentsPage";
import { CheckYourAnswersPage } from "../../pages/edgeCases/submission/checkYourAnswersPage";
import { StatementOfTruthPage } from "../../pages/edgeCases/submission/statementOfTruthPage";
import { NeedHelpWithFeesPage } from "../../pages/edgeCases/payment/needHelpWithFeesPage";
import { PayYourFeePage } from "../../pages/edgeCases/payment/payYourFeePage";
import { FeesAppliedPage } from "../../pages/edgeCases/payment/feesAppliedPage";
import { Helpers } from "../../common/helpers";
import { PayPage } from "../../pages/edgeCases/payment/payPage";
import { PaymentConfirmationPage } from "../../pages/edgeCases/payment/paymentConfirmationPage";
import { ApplicationSubmitted } from "../../pages/edgeCases/submission/applicationSubmittedPage";
