...
} from "../../../../../fixtures/manageCases/createCase/FL401/withoutNoticeOrder/withoutNoticeOrderDetails1Content";
...
export class WithoutNoticeOrder1Page{
  ...
  private static async fillInFields(
    ...
    if (isWithoutNotice) {
      await page.click(
        WithoutNoticeOrderRadioIDs.radioYes
      );
    } else {
      await page.click(

        WithoutNoticeOrderRadioIDs.radioNo
      );
    }
    await page.click(
      `${Selectors.button}:text-is("${WithoutNoticeOrderDetails1Content.continue}")`
