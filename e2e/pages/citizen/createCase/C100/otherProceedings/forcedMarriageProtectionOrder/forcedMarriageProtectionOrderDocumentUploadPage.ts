...
import { ForcedMarriageProtectionDocumentUploadContent } from "../../../../../../fixtures/citizen/createCase/C100/otherProceedings/forcedMarriageProtection/forcedMarriageProtectionDocumentUploadContent";
...
export class ForcedMarriageProtectionDocumentUploadPage {
  ...
  private static async triggerErrorMessages(page: Page): Promise<void> {
    ...
    await Promise.all([
      ...
      Helpers.checkVisibleAndPresent(
        page,
        `${Selectors.ErrorMessage}:text-is("${ForcedMarriageProtectionDocumentUploadContent.errorMessageChooseFile}")`,
        1,
      ),
    ]);
    ...
    await Promise.all([
      ...
      Helpers.checkVisibleAndPresent(
        page,
        `${Selectors.ErrorMessage}:text-is("${ForcedMarriageProtectionDocumentUploadContent.errorMessageUploadCorrectFile}")`,
        1,
      ),
    ]);
  }
