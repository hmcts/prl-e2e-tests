...
import { EmergencyProtectionOrderDetailsContent } from "../../../../../fixtures/citizen/createCase/C100/otherProceedings/EmergencyProtectionOrderDetailsContent.ts";
...
export class EmergencyProtectionOrderDetailsPage {
  ...
  private static async triggerErrorMessages(page: Page): Promise<void> {
    ...
    await Promise.all([
      ...
      Helpers.checkVisibleAndPresent(
        page,
        `${Selectors.GovukErrorMessageCitizen}:text-is("${EmergencyProtectionOrderDetailsContent.errorMessageOrderDate}")`,
        1,
      ),
      Helpers.checkVisibleAndPresent(
        page,
      ...
      Helpers.checkVisibleAndPresent(
        page,
        `${Selectors.GovukErrorMessageCitizen}:text-is("${EmergencyProtectionOrderDetailsContent.errorMessageOrderEndDate}")`,
        1,
      ),
    ]);
  }
