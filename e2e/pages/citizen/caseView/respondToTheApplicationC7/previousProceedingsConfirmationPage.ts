...
export class PreviousProceedingsConfirmationPage {
  public static async previousProceedingsConfirmationPage(
    page: Page,
  ...
  private static async checkPageLoads(
    ...
    await Promise.all([
      ...
      Helpers.checkVisibleAndPresent(
        page,
        `${Selectors.GovukLink}:text-is("${PreviousProceedingsContent.linkEdit}")`,
        2,
      ),
    ]);
