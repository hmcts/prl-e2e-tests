...
export class InternationalElements2Page {
  public static async internationalElements2Page(
    page: Page,
  ...
  private static async checkPageLoads(
    ...
    await page
      .locator(Selectors.GovukHeadingL, {
        hasText: InternationalElementsContent.page2h1,
      })
      .waitFor();
    await Helpers.checkVisibleAndPresent(
      page,
      `${Selectors.GovukHint}:text-is("${InternationalElementsContent.page2hint}")`,
      1,
    );
