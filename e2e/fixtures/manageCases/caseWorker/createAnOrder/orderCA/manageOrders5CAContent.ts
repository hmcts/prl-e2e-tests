export enum ManageOrders5CAContent {
  ...
  label21 = "Add recitals or preamble (Optional)",
  label22 = "Add directions (Optional)",
  hiddenLabel1 = "At which hearing was the order approved?",
  hiddenLabel2 = "Day",
  hiddenLabel3 = "Month",
  hiddenLabel4 = "Year",
  hearing = "No hearings available",
  judgeFullName = "judgeFirstName judgeLastName",
  approvedAtAHearing = "Was the order approved at a hearing?",
}
