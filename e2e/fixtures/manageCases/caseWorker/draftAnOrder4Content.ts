export enum DraftAnOrder4Content {
  ...
  errorMessage4 = "Date order made is not valid",
  errorMessage5 = "At which hearing was the order approved? is required",
  errorMessage6 = "Magistrate's full name is required",
  errorMessage7 = "Which children are included in the order? is required",
