export enum ManageFlagsSelectCaseFlagContent {
  ...
  c100GovUkLabelReasonableAdjustment = "John Doe (Applicant 1) - Reasonable adjustment, Documents in a specified colour (test comments)",
  c100GovUkLabelLanguageInterpreter = "John Doe (Applicant 1) - Language Interpreter, Korean (test comments)",
}
