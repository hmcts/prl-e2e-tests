export enum ManageDocumentsNew1Content {
  ...
  buttonText = "Add new",
  buttonText2 = "Remove",
  p = "Upload a file to the system",
  formHint1 = "Select a party",
  formHint2 = "Select a document category",
  formHint3 = "File size must be under 500MB.",
  formHint4 = "Only HMCTS staff and the judiciary will be able to see it.",
  formHint5 = "The court will only restrict a document if there is a very good reason.Only court staff and the judiciary will be able to see it.",
