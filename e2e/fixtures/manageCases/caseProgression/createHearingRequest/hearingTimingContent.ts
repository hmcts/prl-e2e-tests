export enum HearingTimingContent {
  ...
  GovukFieldsetHeading3 = "What is the priority of this hearing?",
  GovukHint = "Availability of all the parties will be taken into account when scheduling this hearing",
  days = "1",
  hours = "0",
  mins = "0",
  continue = "Continue",
