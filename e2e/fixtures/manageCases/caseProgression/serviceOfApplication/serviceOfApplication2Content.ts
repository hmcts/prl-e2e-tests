export enum ServiceOfApplication2Content {
  ...
  formHint1 = "Select the orders and notices that you want to serve on parties.",
  formHint2 = "Upload the version that is used by your court.",
  p1 = "Upload any additional documents in your service pack that are due to be sent to both the applicant and the respondent.",
  p2 = "Documents served in the pack",
