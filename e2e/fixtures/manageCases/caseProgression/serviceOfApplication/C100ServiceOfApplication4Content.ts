export enum C100ServiceOfApplication4Content {
  formLabel1 = "Does this application need to be personally served on the respondent?",
  formLabel2 = "Not applicable",
  formLabel3 = "Does Cafcass Cymru need to be served?",
  formLabel4 = "Cafcass Cymru email address",
  formLabel5 = "Does the local Authority need to be served?",
