export enum NocSubmitContent {
  ...
  applicantGovSummaryListValue1 = "Applicant",
  applicantGovSummaryListValue2 = "ApplLast",
  respondentGovSummaryListValue1 = "Dolores",
  respondentGovSummaryListValue2 = "Smith",
