export enum JudgeCreateOrderDASubmitContent {
  ...
  spanOccupationOrder = "Occupation order (FL404B)",
  occupationOrderA = "occupation_order_fl404_draft.pdf",
  text16B1 = "Hearing",
  ...
  spanAmendDischargedVaried = "Amended, discharged or varied order (FL404B)",
  amendDischargedVariedOrderA = "amended_discharged_or_varied_order_fl404b_draft.pdf",
  text16C1 = "Hearing",
  text16C2 = "Create an order",
  text16C3 = "Amended, discharged or varied order (FL404B)",
  text16C4 = "Deputy Circuit Judge",
  text16C5 = "Hearing outcome",
  text16C6 = "Hearing 1",
  text16C7 = "Hearing Type",
  text16C8 = "Has the hearing date been confirmed?",
  confirmationMessage = "has been updated with event: Manage orders",
}
