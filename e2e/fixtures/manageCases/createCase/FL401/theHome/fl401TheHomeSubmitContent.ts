export enum Fl401TheHomeSubmitContent {
  ...
  filledText163 = "The applicant doesn’t want the respondent to be able to enter the home",
  filledText164 = "The applicant wants to keep the respondent away from the area surrounding their home",
  filledText165 = "The applicant wants to limit where in their home the respondent can go",
  filledText166 = "The applicant needs the respondent to pay for or contribute to repairs or maintenance to the home",
  filledText167 = "The applicant needs the respondent to pay for or contribute to the rent or the mortgage",
  filledText168 = "The applicant needs the use of the furniture or other household contents",
  filledText169 = "The applicant’s child or children",
  filledText1610 = "123456789",
  filledText1611 = "Automated Mortgage Lender",
  filledText1612 = "Automated Landlord",

  textArea1 = "Automated Grandparents",
  textArea2 = "Some automated details to be considered by court",
  textArea3 = "Automated Property Adaptations",
