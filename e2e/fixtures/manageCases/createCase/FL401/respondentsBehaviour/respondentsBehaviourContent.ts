export enum RespondentsBehaviourContent {
  title = "Respondent's behaviour",
  ...
  formLabel1 = "*What does the applicant want to stop the respondent from doing? (Optional)",
  ...
  formLabel11 = "What does the applicant want to stop the respondent from doing to their child or children (if applicable)? (Optional)",
  ...
  formLabel17 = "*Is there anything else the applicant wants the respondent to stop doing that is not mentioned in the questions above? (Optional)",
  continue = "Continue",
