export enum AttendingTheHearing1Content {
  ...
  inputErrorMessage1 = " *Will the applicant, or anyone else attending court, need to speak Welsh or read and write in Welsh during the proceedings? is required ",
