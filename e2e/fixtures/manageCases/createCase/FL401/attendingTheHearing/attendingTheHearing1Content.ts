export enum AttendingTheHearing1Content {
  ...
  peopleInvolved = '*Provide the names of the people involved in the case who need to speak Welsh or read and write in Welsh.',
  welshLabel1 = 'Will need to speak Welsh',
  welshLabel2 = 'Will need to read and write in Welsh',
