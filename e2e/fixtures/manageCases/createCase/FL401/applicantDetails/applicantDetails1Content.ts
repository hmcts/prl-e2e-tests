export enum ApplicantDetails1Content {
  ...
  invalidErrorHeading = ' The event could not be created ',
  invalidErrorP = 'Case data validation failed',
  topLevelInvalidSummary1 = 'The data entered is not valid for this type of field, please delete and re-enter using only valid data',
  topLevelInvalidSummary2 = ' Select or fill the required *Telephone number field ',
  topLevelInvalidMessage1 = ' Date or Time entered is not valid ',
  topLevelInvalidMessage2 = ' The data entered is not valid for this type of field, please delete and re-enter using only valid data ',
  ...
  secondLevelInvalidEmailSummary = ' is not a valid Email address',
  secondLevelInvalidEmailMessage = ' is not a valid Email address',
  continue = 'Continue',
}