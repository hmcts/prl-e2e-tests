export enum ApplicantDetailsSubmitContent {
  ...
  text166 = "*Gender",
  text167 = "*Do you need to keep their address confidential?",
  text168 = "*Can you provide their email address?",
  text169 = "*Contact Number",
  text1610 = "*Do you need to keep their contact number confidential?",
  ...
  text1617 = "Name:",
  text1618 = "Address:",
  text1619 = "*Do you need to keep their email address confidential?",
