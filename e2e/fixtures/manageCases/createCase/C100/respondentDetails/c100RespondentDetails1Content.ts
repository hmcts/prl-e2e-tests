export enum C100RespondentDetails1Content {
  ...
  formLabel10 = "*Do they live in a refuge? (Optional)",
  formLabel11 = "*Do you know their current address? (Optional)",
  formLabel12 = "*Has respondent lived at this address for less than 5 years? (Optional)",
  formLabel13 = "*Can you provide their email address? (Optional)",
  formLabel14 = "*Can you provide a contact number? (Optional)",
  formLabel15 = "*Do they have legal representation? (Optional)",
  continue = "Continue",
