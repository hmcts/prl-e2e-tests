export enum C100RespondentDetails1Content {
  ...
  formLabelYes4 = "*Representative's first name (Optional)",
  formLabelYes5 = "*Representative's last name (Optional)",
  formLabelYes6 = "*Email Address (Optional)",
  formLabelYes7 = "DX Number (Optional)",
  formLabelYes8 = "If the organisation you need isn’t listed, enter their details to send them a sign-up request Organisation name (Optional)",
