export enum InternationalElementSubmitPage {
  ...
  text162 = "Do you have any reason to believe that any child, parent or potentially significant adult in the child's life may be habitually resident in another state?",
  text163 = "Do you have any reason to believe that there may be an issue as to jurisdiction in this case?",
