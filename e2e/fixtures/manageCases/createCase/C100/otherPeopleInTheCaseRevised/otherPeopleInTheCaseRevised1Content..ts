export enum OtherPeopleInTheCase1Content {
  ...
  formLabelGender1 = "Male",
  formLabelGender2 = "Female",
  FormLabelGender3 = "They identify in another way",
  formLabelDay = "Day",
  ...
  errorMessageInvalidDOB = " The data entered is not valid for *Date of birth ",
