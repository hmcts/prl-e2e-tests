export enum ApplicantDetails1Content {
  ...
  errorMessageAddressConfidentialRequired = "*Do you need to keep their address confidential? is required",
  ...
  errorMessageEmailAddressProvidedRequired = "*Can you provide their email address? is required",
  errorMessageContactNumberRequired = "*Contact Number is required",
  errorMessageEmailAddressRequired = "*Email address is required",
  errorMessageContactNumberConfidentialRequired = "*Do you need to keep their contact number confidential? is required",
