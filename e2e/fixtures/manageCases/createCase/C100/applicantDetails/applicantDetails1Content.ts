export enum ApplicantDetails1Content {
  ...
  formLabel11 = "*Has applicant lived at this address for less than 5 years?",
  formLabel12 = "*Can you provide email address?",
  formLabel13 = "*Contact Number",
  formLabel14 = "*Do you need to keep the contact number confidential?",
  formLabel15 = "*Representative's first name (Optional)",
  formLabel16 = "*Representative's last name (Optional)",
  formLabel17 = "*Email address (Optional)",
  formLabel18 = "Solicitor reference (Optional)",
  formLabel19 = "DX Number (Optional)",
  formLabelDay = "Day",
