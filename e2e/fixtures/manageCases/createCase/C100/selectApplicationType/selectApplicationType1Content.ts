export enum SelectApplicationType1Content {
  ...
  additionalFormLabel1 = "*Select type of child arrangements order",
  additionalFormLabel2 = "Spend time with order",
  additionalFormLabel3 = "Live with order",
  additionalFormLabel4 = "Both live with and spend time with order",

  p2 = "Provide more information on the type of order you are requesting.",

  additionalFormLabel5 = "*For example-does the order detail who the child will live with, or how often they will spend type with a parent.",
  ...
  errorMessageSelectChildArrangementOrder = "*Select type of child arrangements order is required",
