export enum SelectApplicationTypeSubmitContent {
  ...
  text169 = "*Is there an order under section 91(14) Children Act 1989, a limited civil restraint order, a general civil restraint order or an extended civil restraint order in force which means you need permission to make this application?",
  text1610 = "Provide case number and name of the court",
  text1611 = "Upload file",
  text16Change = "Change",
  text16Yes = "Yes",
  text16No = "No",
