export enum AllegationsOfHarmRevised8Content {
  ...
  formLabelNo = "No",
  continue = "Continue",
  natureOfBehaviour = "Lorem ipsum nature of behaviour Emotional abuse",
  durationOfBehaviour = "Lorem ipsum duration of behaviour Emotional abuse",
  seekHelp = "Lorem ipsum seek help Emotional abuse",
}
