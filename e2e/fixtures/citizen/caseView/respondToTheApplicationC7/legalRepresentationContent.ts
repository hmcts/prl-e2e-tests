export enum LegalRepresentationC7Content {
  //page2
  heading1 = "Will you be using a legal representative to respond to the application?",
  insetText = "You can respond to the applicant's request yourself and then redirect your case to your legal representative for the remainder of the proceedings.",
  radioNo = "No",
  radioYes = "Yes",
  link1 = "Find legal representation",
  link2 = "Do you need legal aid?",
  //page3 confirmation
  h1 = "Complete your response",
  p1 = "Complete your response to the applicant's request for child arrangements.",
