export enum UploadSupportingDocumentsContent {
  ...
  p1 = "If you are uploading a paper copy of the document, make sure this has been scanned in clearly and saved in a suitable format such as PDF.",
  h2 = "Upload documents",
