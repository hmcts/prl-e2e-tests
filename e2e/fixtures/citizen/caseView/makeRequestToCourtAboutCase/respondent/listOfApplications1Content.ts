export enum ListOfApplications1Content {
  ...
  GovukBody6 = "You can appeal or ask for permission to appeal a court order by completing and submitting and completing form N161.",
  GovukLink7 = "Apply to the court using form N161",
  next = "2 of 2",
}