export enum FeesAppliedContent {
  pageTitle = "Have you already applied for help with your application fee?",
  formLabel = "Enter your help with fees reference number",
  formHint = "You received this number when you applied for help with fees. For example, HWF-A1B-23C",
