export enum PersonalDetailsContent {
  ...
  invalidDateApproxErrorList = "Approx date of birth is not valid",
  invalidDateApproxErrorMessage = "Approx date of birth is not valid",
  ...
  sharedDoBError = 'Cannot have a date of birth and also "I dont know their date of birth"',
  dobDay = "17",
  dobMonth = "12",
  dobYear = "1990",
  approxDoBDay = "17",
