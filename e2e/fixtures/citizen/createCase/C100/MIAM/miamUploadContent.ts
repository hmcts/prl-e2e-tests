export enum MiamUploadContent {
  pageTitle = "Upload your MIAM certificate",
  govukBody1 = "If you are uploading documents from a computer, name the files clearly. For example, miam-certificate.doc.",
  govukBody2 = "Files must end with JPG, BMP, PNG,TIF, PDF, DOC or DOCX.",
  ...
  li5 = "Upload it here.",
  govukLabel = "Select documents to upload",
  errorMessageNoUpload = "Please choose a file.",
