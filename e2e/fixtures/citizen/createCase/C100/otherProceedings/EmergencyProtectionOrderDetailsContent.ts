export enum EmergencyProtectionOrderDetailsContent {
  ...
  legend1 = "Emergency Protection Order",
  legend2 = "Is this a current order? (optional)",
  legend3 = "What date did it end? (optional)",
  legend4 = "Do you have a copy of the order? (optional) ",
  legend5 = "What date was it made? (optional)",
