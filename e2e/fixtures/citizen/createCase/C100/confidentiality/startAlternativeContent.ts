export enum StartAlternativeContent {
  pageTitle = "Do you want to keep your contact details private from the other people named in the application (the respondents)?",
  ...
  errorMessage = " Select yes if you want to keep your details  ",
  formHint = 'Specify which contact details you want to keep private.',
  formLabel1 = 'Address',
